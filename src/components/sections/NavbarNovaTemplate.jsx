        ...
        <div className="container mx-auto flex items-center m-auto max-w-[1215px] h-full w-[90%] justify-between py-2">
          <div
            className={`flex flex-col z-20 relative  ${
              isScrolled
                ? 'w-[20%] tablet1:w-[20%] tablet2:w-[15%] desktop1:w-[15%] desktop2:w-[12%] desktop3:w-[10%] transition-all duration-700'
                : 'w-[40%] phone2:w-[30%] phone3:w-[25%] tablet1:w-[30%] tablet2:w-[20%] desktop1:w-[18%] desktop2:w-[15%] desktop3:w-[15%] transition-all duration-700'
            }`}
          >
            {' '}
            <img
